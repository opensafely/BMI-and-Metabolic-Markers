#### Author: M Samuel
#### Date: 15th June
####  This script looks at the demographics of the total population in each group after low bmi and cancer removed
...
write.csv (demographics, here::here ("output/data","demographics_bmi_change_analysis_lowbmiexc.csv"))
