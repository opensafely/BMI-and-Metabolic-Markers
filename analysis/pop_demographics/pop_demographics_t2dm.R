...
write.csv (demographics, here::here ("output/data","demographics_study_population_t2dm.csv"))
write.csv (demographics_2, here::here ("output/data","demographics_had_bmi_t2dm.csv"))
