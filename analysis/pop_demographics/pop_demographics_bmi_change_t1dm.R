...
write.csv (demographics, here::here ("output/data","demographics_bmi_change_analysis_lowbmiexc_t1dm.csv"))



write.csv (demographics_all, here::here ("output/data","demographics_bmi_change_analysis_all_t1dm.csv"))
