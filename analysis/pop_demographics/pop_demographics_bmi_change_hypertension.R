...
write.csv (demographics, here::here ("output/data","demographics_bmi_change_analysis_lowbmiexc_hypertension.csv"))



write.csv (demographics_all, here::here ("output/data","demographics_bmi_change_analysis_all_hypertension.csv"))
