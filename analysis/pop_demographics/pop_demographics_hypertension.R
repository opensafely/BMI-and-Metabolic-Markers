...
################ PART_2 ::: Demographics of those who had a BMI measure

## had_bmi data

BMI_data <- BMI_data %>%
  dplyr::filter(had_bmi == "TRUE")
...
demographics_2 <- demographics_2 %>% 
  dplyr::mutate(n = plyr::round_any(demographics_2$n, 5))
...
write.csv (demographics, here::here ("output/data","demographics_study_population_hypertension.csv"))
write.csv (demographics_2, here::here ("output/data","demographics_had_bmi_hypertension.csv"))
