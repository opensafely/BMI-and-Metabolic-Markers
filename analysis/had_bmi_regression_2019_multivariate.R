...
## Multivariate analysis of who had BMI measured in 2019
...
# had_bmi_age_sex_m <- glm(had_bmi ~ age_group + sex, data=BMI_complete_categories_2019, family=binomial) %>%
...
models_age_sex_ethnic_2019 <- explanatory_vars_multivariate %>%       # begin with variables of interest
...
####################################################################################
## OUTPUTS
write.csv (models_age_sex_ethnic_2019, here::here ("output/data","multivariate_regression_had_bmi_2019.csv"))
