...
transitions <- transitions %>% 
    ungroup()%>%
  dplyr::mutate(n = plyr::round_any(transitions$n, 5)) %>% 
  dplyr::mutate(total = plyr::round_any(transitions$total, 5))
...
models_normal_weight <- explanatory_vars_1 %>%       # begin with variables of interest
  str_c("transition_bmi25  ~ age_group_2 + ", .) %>%         # combine each variable into formula ("outcome ~ variable of interest")
...
models_overweight <- explanatory_vars_1 %>%       # begin with variables of interest
  str_c("become_obese ~ age_group_2 + ", .) %>%         # combine each variable into formula ("outcome ~ variable of interest")
...
models_overweight_weightloss <- explanatory_vars_1 %>%       # begin with variables of interest
  str_c("bmi2_under25 ~ age_group_2 + ", .) %>%         # combine each variable into formula ("outcome ~ variable of interest")
...
models_obese_weightloss <- explanatory_vars_1 %>%       # begin with variables of interest
  str_c("weightloss ~ age_group_2 + ", .) %>%         # combine each variable into formula ("outcome ~ variable of interest")
...
write.csv (transitions, here::here ("output/data","bmi_category_transitions_round.csv"))

write.csv (models_normal_weight, here::here ("output/data","healthy_transition_weightgain_age_adj.csv"))
write.csv (models_normal_weight_2017, here::here ("output/data","healthy_transition_weightgain_2017_age_adj.csv"))
write.csv (models_normal_weight_2019, here::here ("output/data","healthy_transition_weightgain_2019_age_adj.csv"))


write.csv (models_overweight, here::here ("output/data","overweight_transition_weightgain_age_adj.csv"))
write.csv (models_overweight_2017, here::here ("output/data","overweight_transition_weightgain_2017_age_adj.csv"))
write.csv (models_overweight_2019, here::here ("output/data","overweight_transition_weightgain_2019_age_adj.csv"))


write.csv (models_overweight_weightloss, here::here ("output/data","overweight_transition_weightloss_age_adj.csv"))
write.csv (models_overweight_weightloss_2017, here::here ("output/data","overweight_transition_weightloss_2017_age_adj.csv"))
write.csv (models_overweight_weightloss_2019, here::here ("output/data","overweight_transition_weightloss_2019_age_adj.csv"))

write.csv (models_obese_weightloss, here::here ("output/data","obese_transition_weightloss_age_adj.csv"))
write.csv (models_obese_weightloss_2017, here::here ("output/data","obese_transition_weightloss_2017_age_adj.csv"))
write.csv (models_obese_weightloss_2019, here::here ("output/data","obese_transition_weightloss_2019_age_adj.csv"))
