...
N_obese <- BMI_complete_categories_2021_DT[, .N, ]
obese_table<- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N),] 
...
obese_age_group <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="age_group"] 
...
obese_sex <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="sex"] 
...
obese_region <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="region"] 
...
obese_imd <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="imd"] 
...
obese_ethnic_no_miss <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="ethnic_no_miss"] 
...
obese_eth_group_16 <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="eth_group_16"] 
...
obese_comorbid_learning_disability <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_learning_disability"] 
...
obese_comorbid_depression <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_depression"] 
...
obese_comorbid_dementia <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_dementia"] 
...
obese_comorbid_psychosis_schiz_bipolar <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_psychosis_schiz_bipolar"] 
...
obese_comorbid_diabetes_t1 <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_diabetes_t1"] 
...
obese_comorbid_diabetes_t2 <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_diabetes_t2"] 
...
obese_comorbid_asthma <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_asthma"] 
...
obese_comorbid_COPD <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_COPD"] 
...
obese_comorbid_stroke_and_TIA <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_stroke_and_TIA"] 
...
obese_comorbid_chronic_cardiac <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_chronic_cardiac"] 
...
obese_comorbid_hypertension <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_hypertension"] 
...
obese_comorbid_all_cancer <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="comorbid_all_cancer"] 
...
obese_precovid_obese_flag <- BMI_complete_categories_2021_DT[obese=="TRUE", .(n_obese= .N), by="precovid_obese_flag"] 
...
write.csv (obese_table, here::here ("output/data","proportion_obese_2021.csv"))
