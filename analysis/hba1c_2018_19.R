...
## >>>  SAVE AS DATA FOR HbA1c analysis: just need to add last hba1c 2018/2019
...
## attach median Hba1c to had_hba1c_2019 >just contains exposure coviariates and whether they had hba1c

hba1c_2019 <- had_hba1c_2019 %>%
...
had_hba1c_2018 <- hba1c_2018 %>%
  dplyr::select(-ends_with("_date"))

had_hba1c_2018 <- had_hba1c_2018 %>%
  dplyr::rowwise (patient_id) %>%
  dplyr::mutate( sum_hba1c = sum(c(
    hba1c_march, 
    hba1c_april,
...
## >>>  SAVE AS DATA FOR HbA1c analysis: just need to add last hba1c 2018/2018
...
write_feather (hba1c_2019, here::here ("output/data","hba1c_2019_summary.feather"))
write_feather (hba1c_2018, here::here ("output/data","hba1c_2018_summary.feather"))
