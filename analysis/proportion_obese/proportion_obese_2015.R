...
write.csv (complete_percentages, here::here ("output/data","obese_all_2015.csv"))
write.csv (complete_hypertension, here::here ("output/data","obese_hypertension_2015.csv"))
write.csv (complete_diabetes_t1, here::here ("output/data","obese_T1DM_2015.csv"))
write.csv (complete_diabetes_t2, here::here ("output/data","obese_T2DM_2015.csv"))
