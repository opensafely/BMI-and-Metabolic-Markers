...
BMI_complete_categories_DWMP <- BMI_complete_categories_DWMP %>%
  ...
  dplyr::mutate(
    precovid_obese = (((median_bmi >=30) & ((year=="2020")| (year=="2020")| (year=="2020")| (year=="2020") | (year=="2020")))) , 
    .after = "patient_id") %>%
  dplyr::mutate(
...
write_feather (BMI_complete_categories, here::here ("output/data","BMI_complete_median_2020.feather"))
