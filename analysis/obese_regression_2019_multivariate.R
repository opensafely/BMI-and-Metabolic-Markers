...
## Multivariate analysis of who was obese in 2019
...
# obese_age_sex_m <- glm(obese ~ age_group + sex, data=BMI_complete_categories_2019, family=binomial) %>%
...
####################################################################################
## OUTPUTS
write.csv (models_age_sex_ethnic_2019, here::here ("output/data","multivariate_regression_obese_2019.csv"))
