...
write.csv (DWMP_eligible_table_2021, here::here ("output/data","proportion_DWMP_T2DM_2021.csv"))

write.csv (DWMP_eligible_table_2020, here::here ("output/data","proportion_DWMP_T2DM_2020.csv"))

write.csv (DWMP_eligible_table_2019, here::here ("output/data","proportion_DWMP_T2DM_2019.csv"))