...
BMI_all_long <- read_feather (here::here ("output/data", "all_bmi_long.feather"))
...
write_feather (BMI_trajectories_complete, here::here ("output/data","BMI_trajectories.feather"))
