...
hba1c_summary <- read_feather (here::here ("output/data", "hba1c_2020_summary.feather"))
...
hba1c_2020_age_group <- hba1c_summary %>%
  tabyl(age_group, had_hba1c) 

hba1c_2020_age_group <- hba1c_2020_age_group %>%
...
### sex
hba1c_2020_sex <- hba1c_summary %>%
  tabyl(sex, had_hba1c) 

hba1c_2020_sex <- hba1c_2020_sex %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
## region
hba1c_2020_region <- hba1c_summary %>%
  tabyl(region, had_hba1c) 

hba1c_2020_region <- hba1c_2020_region %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
## imd
hba1c_2020_imd <- hba1c_summary %>%
  tabyl(imd, had_hba1c) 

hba1c_2020_imd <- hba1c_2020_imd %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_ethnic_no_miss <- hba1c_summary %>%
  tabyl(ethnic_no_miss, had_hba1c) 

hba1c_2020_ethnic_no_miss <- hba1c_2020_ethnic_no_miss %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
## 16 group eth
hba1c_2020_eth_group_16 <- hba1c_summary %>%
  tabyl(eth_group_16, had_hba1c) 

hba1c_2020_eth_group_16 <- hba1c_2020_eth_group_16 %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_learning_disability <- hba1c_summary %>%
  tabyl(comorbid_learning_disability, had_hba1c) 

hba1c_2020_comorbid_learning_disability <- hba1c_2020_comorbid_learning_disability %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_depression <- hba1c_summary %>%
  tabyl(comorbid_depression, had_hba1c) 

hba1c_2020_comorbid_depression <- hba1c_2020_comorbid_depression %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_dementia <- hba1c_summary %>%
  tabyl(comorbid_dementia, had_hba1c) 

hba1c_2020_comorbid_dementia <- hba1c_2020_comorbid_dementia %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_psychosis_schiz_bipolar <- hba1c_summary %>%
  tabyl(comorbid_psychosis_schiz_bipolar, had_hba1c) 

hba1c_2020_comorbid_psychosis_schiz_bipolar <- hba1c_2020_comorbid_psychosis_schiz_bipolar %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_asthma <- hba1c_summary %>%
  tabyl(comorbid_asthma, had_hba1c) 

hba1c_2020_comorbid_asthma <- hba1c_2020_comorbid_asthma %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_COPD <- hba1c_summary %>%
  tabyl(comorbid_COPD, had_hba1c) 

hba1c_2020_comorbid_COPD <- hba1c_2020_comorbid_COPD %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_stroke_and_TIA <- hba1c_summary %>%
  tabyl(comorbid_stroke_and_TIA, had_hba1c) 

hba1c_2020_comorbid_stroke_and_TIA <- hba1c_2020_comorbid_stroke_and_TIA %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_chronic_cardiac <- hba1c_summary %>%
  tabyl(comorbid_chronic_cardiac, had_hba1c) 

hba1c_2020_comorbid_chronic_cardiac <- hba1c_2020_comorbid_chronic_cardiac %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_hypertension <- hba1c_summary %>%
  tabyl(comorbid_hypertension, had_hba1c) 

hba1c_2020_comorbid_hypertension <- hba1c_2020_comorbid_hypertension %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_all_cancer <- hba1c_summary %>%
  tabyl(comorbid_all_cancer, had_hba1c) 

hba1c_2020_comorbid_all_cancer <- hba1c_2020_comorbid_all_cancer %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_comorbid_dm_meds  <- hba1c_summary %>%
  tabyl(dm_meds, had_hba1c)

hba1c_2020_comorbid_dm_meds <- hba1c_2020_comorbid_dm_meds %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
hba1c_2020_precovid_control <- hba1c_summary %>%
  tabyl(precovid_control, had_hba1c) 

hba1c_2020_precovid_control <- hba1c_2020_precovid_control %>%
  dplyr::rename(n_had_hba1c = 'TRUE') %>% 
  dplyr::rename(n_no_hba1c = 'FALSE') %>%
  dplyr::mutate(N_total = n_no_hba1c + n_had_hba1c) %>%
  dplyr::select(-('n_no_hba1c'))  %>%
...
had_hba1c_2020 <- hba1c_population %>% 
  bind_rows(hba1c_2020_age_group) %>%
  bind_rows(hba1c_2020_sex) %>%
  bind_rows(hba1c_2020_region) %>%
  bind_rows(hba1c_2020_imd) %>%
  bind_rows(hba1c_2020_ethnic_no_miss) %>% 
  bind_rows(hba1c_2020_eth_group_16) %>% 
  bind_rows(hba1c_2020_comorbid_dm_meds) %>%
  bind_rows(hba1c_2020_precovid_control) %>%
  bind_rows(hba1c_2020_comorbid_hypertension) %>% 
  bind_rows(hba1c_2020_comorbid_learning_disability) %>% 
  bind_rows(hba1c_2020_comorbid_depression) %>% 
  bind_rows(hba1c_2020_comorbid_dementia) %>% 
  bind_rows(hba1c_2020_comorbid_psychosis_schiz_bipolar) %>% 
  bind_rows(hba1c_2020_comorbid_asthma) %>% 
  bind_rows(hba1c_2020_comorbid_COPD) %>% 
  bind_rows(hba1c_2020_comorbid_stroke_and_TIA) %>% 
  bind_rows(hba1c_2020_comorbid_chronic_cardiac) %>% 
  bind_rows(hba1c_2020_comorbid_all_cancer)

had_hba1c_2020 <- had_hba1c_2020 %>%
dplyr::mutate('p.value' = round(p.value, 2)) 

write.csv (had_hba1c_2020, here::here ("output/data","T2DM_proportion_hba1c_2020.csv"))