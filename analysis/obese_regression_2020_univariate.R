...
## Univariate analysis of who was obese in 2020
...
obese_age_m <- glm(obese ~ age_group, data=BMI_complete_categories_2020, family=binomial) %>%
...
obese_age_table <- BMI_complete_categories_2020 %>%
...
univariate_obese_2020 <- univ_tab_base  %>%
...
####################################################################################
## OUTPUTS
write.csv (univariate_obese_2020, here::here ("output/data","regression_obese_2020.csv"))
