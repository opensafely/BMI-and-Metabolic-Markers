...
write.csv (all, here::here ("output/data","DWMP_eligible_5yr_data_years.csv"))
write.csv (complete_percentages, here::here ("output/data","DWMP_eligible_5yr_data_all.csv"))
write.csv (complete_hypertension, here::here ("output/data","DWMP_eligible_5yr_data_hypertension.csv"))
write.csv (complete_diabetes_t1, here::here ("output/data","DWMP_eligible_5yr_data_T1DM.csv"))
write.csv (complete_diabetes_t2, here::here ("output/data","DWMP_eligible_5yr_data_T2DM.csv"))