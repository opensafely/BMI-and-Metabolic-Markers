...
# 1) Read in files
#  BMI_complete_median_2019.feather :: contains BMI data on those who had a BMI check
...
all_patients_2019 <- as_tibble (input_all_2019_03_01)
...
all_patients_2019 <- all_patients_2019 %>%
...
# label
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="1"]<-"White"
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="2"]<-"Mixed"
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="3"]<-"Asian"
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="4"]<-"Black"
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="5"]<-"Other"
all_patients_2019$ethnic_no_miss[all_patients_2019$ethnic_no_miss=="0"]<-"Not_recorded"
...
all_patients_2019$imd[all_patients_2019$imd=="0"]<-"NA"
...
BMI_complete_categories_all <- left_join(all_patients_2019, BMI_complete_categories_all, by='patient_id')


### save outputs as feather

write_feather (BMI_complete_categories_all, here::here ("output/data","BMI_all_2019.feather"))
