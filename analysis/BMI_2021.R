...
BMI_2021$ethnic_no_miss[BMI_2021$ethnic_no_miss=="3"]<-"Asian"
BMI_2021$ethnic_no_miss[BMI_2021$ethnic_no_miss=="4"]<-"Black"
BMI_2021$ethnic_no_miss[BMI_2021$ethnic_no_miss=="5"]<-"Other"
BMI_2021$ethnic_no_miss[BMI_2021$ethnic_no_miss=="0"]<-"Not_recorded"
...
write_feather (BMI_complete_long, here::here ("output/data","BMI_complete_long_2021.feather"))
