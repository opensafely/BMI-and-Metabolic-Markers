...
## Univariate analysis of who was obese in 2019
...
obese_age_m <- glm(obese ~ age_group, data=BMI_complete_categories_2019, family=binomial) %>%
...
obese_age_table <- BMI_complete_categories_2019 %>%
...
univariate_obese_2019 <- univ_tab_base  %>%
...
####################################################################################
## OUTPUTS
write.csv (univariate_obese_2019, here::here ("output/data","regression_obese_2019.csv"))
