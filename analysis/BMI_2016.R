...
#BMI_2016 <- read_feather (here::here ("Documents/Academic GP/Open Safely/Dummy Data", "complete_meds_2016.feather"))
...
BMI_2016 <- read_feather (here::here ("output/data", "complete_meds_2016.feather"))
...
### label
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="1"]<-"White"
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="2"]<-"Mixed"
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="3"]<-"Asian"
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="4"]<-"Black"
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="5"]<-"Other"
BMI_2016$ethnic_no_miss[BMI_2016$ethnic_no_miss=="0"]<-"Not_recorded"
...
# had_bmi_imd_m <- glm(had_bmi ~ imd, data=BMI_2016, family=binomial) %>%
...
BMI_complete_long <- demog_2016 %>%
  dplyr::left_join(bmi_2016_long) %>%
...
BMI_2016_median <- median_bmi %>% 
  left_join(demog_2016) %>% 
  dplyr::mutate("year" = "2016")


### classify as underweight, healthyweight, overweight, obese
BMI_complete_categories <- ungroup(BMI_2016_median)
...
###########################################################################################################
write.csv (BMI_data_checks, here::here ("output/data","BMI_data_checks_2016.csv"))

write_feather (BMI_complete_categories_DWMP, here::here ("output/data","BMI_complete_median_2016.feather"))
