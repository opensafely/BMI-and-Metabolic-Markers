...
BMI_2016$imd[BMI_2016$imd=="0"]<-"NA"
BMI_2016$imd[BMI_2016$imd=="1"]<-"1 most deprived"
BMI_2016$imd[BMI_2016$imd=="2"]<-"2"
BMI_2016$imd[BMI_2016$imd=="3"]<-"3"
BMI_2016$imd[BMI_2016$imd=="4"]<-"4"
BMI_2016$imd[BMI_2016$imd=="5"]<-"5 least deprived"
...
had_bmi_eth_16 <- glm(had_bmi ~ eth_group_16, data=BMI_2016, family=binomial) %>%
 broom::tidy(exponentiate = TRUE, conf.int = TRUE) %>%        # exponentiate and produce CIs
  dplyr::mutate(across(where(is.numeric), round, digits = 2)) 
