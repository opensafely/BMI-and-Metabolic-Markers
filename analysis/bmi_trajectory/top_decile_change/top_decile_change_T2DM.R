...
write_csv (models_univar, here::here ("output/data","change_90th_univariate_lowbmiexc_T2DM.csv"))

write_csv (quantiles, here::here ("output/data","change_deciles_lowbmiexc_T2DM.csv"))

write_csv (change_demog, here::here ("output/data","change_90th_counts_lowbmiexc_T2DM.csv"))

write_csv (models_age, here::here ("output/data","change_90th_age_adj_lowbmiexc_T2DM.csv"))

write_csv (models_sex, here::here ("output/data","change_90th_sex_adj_lowbmiexc_T2DM.csv"))

write_csv (models_agesex, here::here ("output/data","change_90th_agesex_adj_lowbmiexc_T2DM.csv"))
