...
eth_group_16_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + eth_group_16, family = binomial)] 
eth_group_16_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + eth_group_16, family = binomial)] 
...
imd_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + imd, family = binomial)] 
imd_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + imd, family = binomial)] 
...
region_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + region, family = binomial)] 
region_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + region, family = binomial)] 
...
hypertension_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + hypertension, family = binomial)] 
hypertension_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + hypertension, family = binomial)] 
...
##
diabetes_t1_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + diabetes_t1, family = binomial)] 
diabetes_t1_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + diabetes_t1, family = binomial)] 
...
diabetes_t2_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + diabetes_t2, family = binomial)] 
diabetes_t2_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + diabetes_t2, family = binomial)] 
...
##
chronic_cardiac_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + chronic_cardiac, family = binomial)] 
chronic_cardiac_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + chronic_cardiac, family = binomial)] 
...
learning_disability_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + learning_disability, family = binomial)] 
learning_disability_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + learning_disability, family = binomial)] 
...
##
depression_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + depression, family = binomial)] 
depression_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + depression, family = binomial)] 
...
##
psychosis_schiz_bipolar_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + psychosis_schiz_bipolar, family = binomial)] 
psychosis_schiz_bipolar_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + psychosis_schiz_bipolar, family = binomial)] 
...
##
asthma_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + asthma, family = binomial)] 
asthma_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + asthma, family = binomial)] 
...
##
COPD_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + COPD, family = binomial)] 
COPD_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + COPD, family = binomial)] 
...
##
stroke_and_TIA_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + stroke_and_TIA, family = binomial)] 
stroke_and_TIA_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + stroke_and_TIA, family = binomial)] 
...
##
dementia_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + dementia, family = binomial)] 
dementia_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + dementia, family = binomial)] 
...
##
all_cancer_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + all_cancer, family = binomial)] 
all_cancer_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + all_cancer, family = binomial)] 
...
##
smoking_status_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + smoking_status, family = binomial)] 
smoking_status_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + smoking_status, family = binomial)] 
...
##
precovid_bmi_category_sex_model <- DT_traj_sex [, glm(change_90th ~  age_group_2 + sex + precovid_bmi_category, family = binomial)] 
precovid_bmi_category_model <- DT_traj_sex[, glm(change_90th ~  age_group_2 + precovid_bmi_category, family = binomial)] 
...
write.csv (age_sex_adjusted, here::here ("output/data","change_90th_age_sex_adjusted_lowbmiexc.csv"))
write.csv (wald_age_sex, here::here ("output/data","change_90th_wald_age_sex.csv"))
