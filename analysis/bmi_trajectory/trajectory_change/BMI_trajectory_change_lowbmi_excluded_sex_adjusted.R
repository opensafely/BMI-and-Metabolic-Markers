...
# develop a vector of explanatory variables
explanatory_vars_hypertension <- c("age_group_2", 
                      "precovid_bmi_category", 
                      "ethnic_no_miss", 
                      "eth_group_16",
                      "imd", 
...
# develop a vector of explanatory variables
explanatory_vars_diabetes <- c("age_group_2", 
                      "precovid_bmi_category", 
                      "ethnic_no_miss", 
                      "eth_group_16",
                      "imd", 
...
write.csv (models_trajectory_change, here::here ("output/data","sex_adjusted_lowbmi_excluded_bmi_trajectory_change.csv"))
write.csv (models_trajectory_change_hypertension, here::here ("output/data","sex_adjusted_lowbmi_excluded_bmi_trajectory_change_hypertension.csv"))
write.csv (models_trajectory_change_T2DM, here::here ("output/data","sex_adjusted_lowbmi_excluded_bmi_trajectory_change_T2DM.csv"))
write.csv (models_trajectory_change_T1DM, here::here ("output/data","sex_adjusted_lowbmi_excluded_bmi_trajectory_change_T1DM.csv"))
