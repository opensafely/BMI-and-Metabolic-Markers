...
write.csv (mean_change, here::here ("output/data","mean_traj_change_by_precovid_change_lowbmiexc.csv"))
write.csv (models, here::here ("output/data","models_traj_change_by_precovid_change_lowbmiexc.csv"))