...
write.csv (models_trajectory_change, here::here ("output/data","sexageimd_adjusted_lowbmi_excluded_bmi_trajectory_change.csv"))
write.csv (models_trajectory_change_hypertension, here::here ("output/data","sexageimd_adjusted_lowbmi_excluded_bmi_trajectory_change_hypertension.csv"))
write.csv (models_trajectory_change_T2DM, here::here ("output/data","sexageimd_adjusted_lowbmi_excluded_bmi_trajectory_change_T2DM.csv"))
write.csv (models_trajectory_change_T1DM, here::here ("output/data","sexageimd_adjusted_lowbmi_excluded_bmi_trajectory_change_T1DM.csv"))
