...
## CORRECTED AND ERROR IN HOW DATA WAS FILTERED
...
# BMI_DT <- read_feather (here::here ("/Users/miriamsamuel/Documents/Academic GP/Open Safely/Dummy Data", "BMI_trajectory_models_data.feather"))
BMI_2 <- read_feather (here::here ("output/data", "BMI_trajectory_data_long.feather"))

 #long_data <- read_feather (here::here ("/Users/miriamsamuel/Documents/Academic GP/Open Safely/Dummy Data", "BMI_trajectories_final_demog.feather"))
