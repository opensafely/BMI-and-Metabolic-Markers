...
### Predictors of trajectory change :  Limit to patients with depression
BMI_DT_depression <-  BMI_DT %>% 
...
## Limit to patients with depression


models_depression_univariate <- explanatory_vars %>%       # begin with variables of interest
  ...
  map(                               
    .f = ~lm(                       # pass the formulas one-by-one to glm()
      ...
      data = BMI_DT_depression)) %>%          # dataset
...
models_depression_sex <- explanatory_vars_sex %>%       # begin with variables of interest
...
models_depression_age <- explanatory_vars_age %>%       # begin with variables of interest
...
models_depression_imd <- explanatory_vars_imd %>%       # begin with variables of interest
...
models_depression_eth <- explanatory_vars_eth %>%       # begin with variables of interest
...
models_depression_sexage <- explanatory_vars_sexage %>%       # begin with variables of interest
...
models_depression_sexageimd <- explanatory_vars_sexage %>%       # begin with variables of interest
...
models_depression_sexageeth <- explanatory_vars_sexage %>%       # begin with variables of interest
...
models_depression_sexageethimd <- explanatory_vars_sexage %>%       # begin with variables of interest
...
write.csv (models_depression_univariate, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_univariate.csv"))
write.csv (models_depression_sex, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_sex_adj.csv"))
write.csv (models_depression_age, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_age_adj.csv"))
write.csv (models_depression_eth, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_ethnicity_adj.csv"))
write.csv (models_depression_imd, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_imd_adj.csv"))
write.csv (models_depression_sexage, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_sexage_adj.csv"))
write.csv (models_depression_sexageimd, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_sexageimd_adj.csv"))
write.csv (models_depression_sexageeth, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_sexageeth_adj.csv"))
write.csv (models_depression_sexageethimd, here::here ("output/data","depression_lowbmi_excluded_bmi_trajectory_change_sexageethimd_adj.csv"))
