...
# develop a vector of explanatory variables
explanatory_vars_hypertension <- c("imd",
                      "precovid_bmi_category", 
                      "ethnic_no_miss", 
                      "eth_group_16",
                      "region", 
...
# develop a vector of explanatory variables
explanatory_vars_diabetes <- c("imd",
                      "precovid_bmi_category", 
                      "ethnic_no_miss", 
                      "eth_group_16",
                      "region", 
...
write.csv (models_trajectory_change, here::here ("output/data","sexage_adjusted_lowbmi_excluded_bmi_trajectory_change.csv"))
write.csv (models_trajectory_change_hypertension, here::here ("output/data","sexage_adjusted_lowbmi_excluded_bmi_trajectory_change_hypertension.csv"))
write.csv (models_trajectory_change_T2DM, here::here ("output/data","sexage_adjusted_lowbmi_excluded_bmi_trajectory_change_T2DM.csv"))
write.csv (models_trajectory_change_T1DM, here::here ("output/data","sexage_adjusted_lowbmi_excluded_bmi_trajectory_change_T1DM.csv"))
