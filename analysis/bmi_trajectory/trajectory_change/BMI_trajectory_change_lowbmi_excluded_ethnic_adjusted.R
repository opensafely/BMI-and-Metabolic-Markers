...
# develop a vector of explanatory variables
explanatory_vars_hypertension <- c("age_group_2", "sex", "imd",
                      "precovid_bmi_category", 
                      "region", 
                      "diabetes_t1",           
                      "diabetes_t2",
...
write.csv (models_trajectory_change, here::here ("output/data","ethnic_adjusted_lowbmi_excluded_bmi_trajectory_change.csv"))
write.csv (models_trajectory_change_hypertension, here::here ("output/data","ethnic_adjusted_lowbmi_excluded_bmi_trajectory_change_hypertension.csv"))
write.csv (models_trajectory_change_T2DM, here::here ("output/data","ethnic_adjusted_lowbmi_excluded_bmi_trajectory_change_T2DM.csv"))
write.csv (models_trajectory_change_T1DM, here::here ("output/data","ethnic_adjusted_lowbmi_excluded_bmi_trajectory_change_T1DM.csv"))
