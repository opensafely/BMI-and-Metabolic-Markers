...
models_postcov_rapidinc_bmi_univar <- explanatory_vars %>%       # begin with variables of interest
  str_c("weightgain_90th ~ age_group_2 + sex + ", .) %>%         # combine each variable into formula ("outcome ~ variable of interest")
...
write_csv (models_postcov_rapidinc_bmi_univar, here::here ("output/data","weightgain_lowbmiexc_90th_agesex_adj.csv"))
