...
bmi_change_quantiles <- precovid_quantiles %>% 
  bind_cols(postcovid_quantiles)
...
write_csv (demog, here::here ("output/data","weightgain_90th_popcharac.csv"))
write_csv (bmi_change_quantiles, here::here ("output/data","yearly_bmi_change_deciles.csv"))
