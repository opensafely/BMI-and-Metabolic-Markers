## This script looks at sex + age adjusted predictors rapid bmi change 
## Author: M Samuel
## Date: 4th May 2022
...
write_csv (models, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_sexage_adjusted.csv"))
