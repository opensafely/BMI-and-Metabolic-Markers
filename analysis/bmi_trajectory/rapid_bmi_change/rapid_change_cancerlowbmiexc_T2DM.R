## This script looks at  adjusted predictors rapid bmi change 
## Author: M Samuel
## Date: 4th May 2022
...
models_univariate <-  models_precov %>%
...
write_csv (models_univariate, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_univariate_T2DM.csv"))
write_csv (models_age, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_age_adjusted_T2DM.csv"))
write_csv (models_sex, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_sex_adjusted_T2DM.csv"))
write_csv (models_imd, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_imd_adjusted_T2DM.csv"))
write_csv (models_agesex, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_sexage_adjusted_T2DM.csv"))
write_csv (models, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_imdsexage_adjusted_T2DM.csv"))
