...
#BMI_2015 <- read_feather (here::here ("Documents/Academic GP/Open Safely/Dummy Data", "complete_meds_2015.feather"))
...
BMI_2015 <- read_feather (here::here ("output/data", "complete_meds_2015.feather"))
...
BMI_2015$ethnic_no_miss[BMI_2015$ethnic_no_miss=="3"]<-"Asian"
BMI_2015$ethnic_no_miss[BMI_2015$ethnic_no_miss=="4"]<-"Black"
BMI_2015$ethnic_no_miss[BMI_2015$ethnic_no_miss=="5"]<-"Other"
BMI_2015$ethnic_no_miss[BMI_2015$ethnic_no_miss=="0"]<-"Not_recorded"
...
# had_bmi_imd_m <- glm(had_bmi ~ imd, data=BMI_2015, family=binomial) %>%
...
BMI_complete_long <- demog_2015 %>%
  dplyr::left_join(bmi_2015_long) %>%
...
###########################################################################################################
write.csv (BMI_data_checks, here::here ("output/data","BMI_data_checks_2015.csv"))

write_feather (BMI_complete_categories_DWMP, here::here ("output/data","BMI_complete_median_2015.feather"))
