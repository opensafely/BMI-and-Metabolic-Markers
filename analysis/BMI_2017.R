...
BMI_2017$ethnic_no_miss[BMI_2017$ethnic_no_miss=="4"]<-"Black"
BMI_2017$ethnic_no_miss[BMI_2017$ethnic_no_miss=="5"]<-"Other"
BMI_2017$ethnic_no_miss[BMI_2017$ethnic_no_miss=="0"]<-"Not_recorded"
...
BMI_2017$imd[BMI_2017$imd=="0"]<-"NA"
BMI_2017$imd[BMI_2017$imd=="1"]<-"1 most deprived"
BMI_2017$imd[BMI_2017$imd=="2"]<-"2"
BMI_2017$imd[BMI_2017$imd=="3"]<-"3"
BMI_2017$imd[BMI_2017$imd=="4"]<-"4"
BMI_2017$imd[BMI_2017$imd=="5"]<-"5 least deprived"
...
## Add a year flag
BMI_complete_long <- long_bmi_2017 %>%
  mutate("year"= 2017)
...
## 2017 mediam BMI per patient:  BMI_2017_median



## CREATE FLAGS and LABEL DEMOGRAPHIS

BMI_complete_median <- BMI_2017_median
...
write_feather (BMI_complete_categories_DWMP, here::here ("output/data","BMI_complete_median_2017.feather"))

write_feather (BMI_complete_long, here::here ("output/data","BMI_complete_long_2017.feather"))
