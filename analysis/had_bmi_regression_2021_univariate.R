...
## Updated: 23rd March 2022 to include whole population in 2021
## Univariate analysis of who had BMI measured in 2021
...
####################################################################################
## OUTPUTS
write.csv (univariate_had_bmi_2021, here::here ("output/data","regression2_had_bmi_2021.csv"))
