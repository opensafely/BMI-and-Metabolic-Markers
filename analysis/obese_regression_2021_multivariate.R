...
## Multivariate analysis of who was obese in 2021
...
# obese_age_sex_m <- glm(obese ~ age_group + sex, data=BMI_complete_categories_2021, family=binomial) %>%
...
####################################################################################
## OUTPUTS
write.csv (models_age_sex_ethnic_2021, here::here ("output/data","multivariate_regression_obese_2021.csv"))
