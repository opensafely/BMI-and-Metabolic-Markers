## Author: M Samuel 
## Date: 5th April 
##This file looks at the analysis of predictors of rapid prepandemic weight gain in a population limited to those with T2D
...
write_csv (complete, here::here ("output/data","CC_delta_prepandemic_models_2_t2d.csv"))