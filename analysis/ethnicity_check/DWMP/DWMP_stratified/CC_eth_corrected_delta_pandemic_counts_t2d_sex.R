...
diabetes_med <-function_1(data_male,   diabetes_med)
...
diabetes_med <-function_3(data_male,   diabetes_med)
...
diabetes_med <-function_4(data_male,   diabetes_med)
...
diabetes_med <-function_5(data_male,   diabetes_med)
...
diabetes_med <-function_6(data_male,   diabetes_med)
...
diabetes_med <-function_7(data_male,   diabetes_med)
...
diabetes_med <-function_1(data_female,   diabetes_med)
...
diabetes_med <-function_3(data_female,   diabetes_med)
...
diabetes_med <-function_4(data_female,   diabetes_med)
...
diabetes_med <-function_5(data_female,   diabetes_med)
...
diabetes_med <-function_6(data_female,   diabetes_med)
...
diabetes_med <-function_7(data_female,   diabetes_med)
...
write_csv (complete_male, here::here ("output/data","CC_delta_pandemic_counts_t2d_male.csv"))
write_csv (complete_female, here::here ("output/data","CC_delta_pandemic_counts_t2d_female.csv"))
