...
diabetes_med <-function_1(data_age_18,   diabetes_med)
...
diabetes_med <-function_3(data_age_18,   diabetes_med)
...
diabetes_med <-function_4(data_age_18,   diabetes_med)
...
diabetes_med <-function_5(data_age_18,   diabetes_med)
...
diabetes_med <-function_6(data_age_18,   diabetes_med)
...
diabetes_med <-function_7(data_age_18,   diabetes_med)
...
diabetes_med <-function_1(data_age_40,   diabetes_med)
...
diabetes_med <-function_3(data_age_40,   diabetes_med)
...
diabetes_med <-function_4(data_age_40,   diabetes_med)
...
diabetes_med <-function_5(data_age_40,   diabetes_med)
...
diabetes_med <-function_6(data_age_40,   diabetes_med)
...
diabetes_med <-function_7(data_age_40,   diabetes_med)
...
diabetes_med <-function_1(data_age_60,   diabetes_med)
...
diabetes_med <-function_3(data_age_60,   diabetes_med)
...
diabetes_med <-function_4(data_age_60,   diabetes_med)
...
diabetes_med <-function_5(data_age_60,   diabetes_med)
...
diabetes_med <-function_6(data_age_60,   diabetes_med)
...
diabetes_med <-function_7(data_age_60,   diabetes_med)
...
write_csv (complete_18, here::here ("output/data","CC_delta_pandemic_counts_t2d_18_39.csv"))
write_csv (complete_40, here::here ("output/data","CC_delta_pandemic_counts_t2d_40_59.csv"))
write_csv (complete_60, here::here ("output/data","CC_delta_pandemic_counts_t2d_60_79.csv"))
