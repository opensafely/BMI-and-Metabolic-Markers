...
write_csv (complete_black, here::here ("output/data","CC_delta_pandemic_models_1_t2d_black.csv"))
write_csv (complete_south_asian, here::here ("output/data","CC_delta_pandemic_models_1_t2d_south_asian.csv"))
