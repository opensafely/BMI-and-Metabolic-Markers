...
diabetes_t1 <-function_6(data_black,   diabetes_t1)
...
diabetes_t1 <-function_7(data_black,   diabetes_t1)
...
diabetes_t1 <-function_6(data_south_asian,   diabetes_t1)
...
diabetes_t1 <-function_7(data_south_asian,   diabetes_t1)
...
write_csv (complete_black, here::here ("output/data","CC_delta_pandemic_counts_hypertension_black.csv"))
write_csv (complete_south_asian, here::here ("output/data","CC_delta_pandemic_counts_hypertension_south_asian.csv"))
