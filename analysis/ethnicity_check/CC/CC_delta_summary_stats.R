...
data <- read_csv (here::here ("output/data", "CC_delta_data.csv"))
...
smoking_status <-function_1(prepandemic,  smoking_status)
...
region <-function_2(prepandemic,  region)
...
smoking_status <-function_2(prepandemic,  smoking_status)
...
smoking_status <-function_3(prepandemic,  smoking_status)
...
smoking_status <-function_4(prepandemic,  smoking_status)
...
smoking_status <-function_5(prepandemic,  smoking_status)
...
region <-function_1(postpandemic,  region)
...
smoking_status <-function_1(postpandemic,  smoking_status)
...
region <-function_2(postpandemic,  region)
...
smoking_status <-function_2(postpandemic,  smoking_status)
...
region <-function_3(postpandemic,  region)
...
smoking_status <-function_3(postpandemic,  smoking_status)
...
region <-function_4(postpandemic,  region)
...
smoking_status <-function_4(postpandemic,  smoking_status)
...
region <-function_5(postpandemic,  region)
...
smoking_status <-function_5(postpandemic,  smoking_status)
...
write_csv (complete, here::here ("output/data","CC_delta_summary_stats.csv"))
