...
# age adjusted
models_postcov <- explanatory_vars %>%       # begin with variables of interest
...
write_csv (models_postcov, here::here ("output/data","rapid_bmi_change_cancerandlowbmi_removed_eth_corrected_eth_adjusted_postcovid.csv"))
