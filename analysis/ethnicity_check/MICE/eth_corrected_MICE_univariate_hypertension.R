...
write.csv (univariate_models, here::here ("output/data", "CC_imputation_sample_univariate_hypertension.csv"))
write.csv (univariate_imputed, here::here ("output/data", "CC_imputation_univariate_hypertension.csv"))
write.csv (demographics, here::here ("output/data", "CC_imputation_sample_pop_demographic_round_hypertension.csv"))