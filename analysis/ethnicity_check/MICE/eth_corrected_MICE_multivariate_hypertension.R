...
write.csv (univariate_models, here::here ("output/data", "CC_imputation_sample_multivariate_hypertension.csv"))
write.csv (univariate_imputed, here::here ("output/data", "CC_imputation_multivariate_hypertension.csv"))
