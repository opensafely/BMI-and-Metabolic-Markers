...
write.csv (univariate_models, here::here ("output/data", "CC_imputation_sample_univariate_t2d.csv"))
write.csv (univariate_imputed, here::here ("output/data", "CC_imputation_univariate_t2d.csv"))
write.csv (demographics, here::here ("output/data", "CC_imputation_sample_pop_demographic_round_t2d.csv"))
