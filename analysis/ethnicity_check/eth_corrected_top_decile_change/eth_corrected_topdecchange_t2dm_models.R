...
models <- models_univariate %>% 
  bind_rows(models_eth, models_age_sex, models_age_sex_imd)
...
write_csv (models, here::here ("output/data","change_90th_t2dm_models_eth_corrected.csv"))
