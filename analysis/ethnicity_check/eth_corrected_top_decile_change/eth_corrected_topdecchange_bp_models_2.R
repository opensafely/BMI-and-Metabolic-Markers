...
regression_vars <- c("region", "diabetes_t2", "diabetes_t1", "chronic_cardiac", "learning_disability",
                     "depression", "dementia", "psychosis_schiz_bipolar", "asthma",
                     "COPD", "stroke_and_TIA", "precovid_bmi_category")
...
write_csv (combined_results, here::here ("output/data","change_90th_bp_models_2.csv"))
