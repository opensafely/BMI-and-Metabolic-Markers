...
## create a flag for 'had-bmi' based on whether a median BMI value is present.  
BMI_median_2$had_bmi_check[is.na(BMI_median_2$had_bmi_check)] <- 'FALSE'
BMI_median_2$had_bmi_check[BMI_median_2$had_bmi_check != 'FALSE'] <- 'TRUE'



had_bmi_numbers_check <- BMI_median_2 %>%
  tabyl(had_bmi_check, had_bmi) %>% 
  adorn_totals %>%
  dplyr::rename(had_bmi_FALSE = 'FALSE') %>%
...
N_had_bmi <- BMI_complete_categories_2019_DT[, .N, ]
had_bmi_table<- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N),] 
...
had_bmi_age_group <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="age_group"] 
...
had_bmi_sex <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="sex"] 
...
had_bmi_region <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="region"] 
...
had_bmi_imd <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="imd"] 
...
had_bmi_ethnic_no_miss <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="ethnic_no_miss"] 
...
had_bmi_eth_group_16 <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="eth_group_16"] 
...
had_bmi_comorbid_learning_disability <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_learning_disability"] 
...
had_bmi_comorbid_depression <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_depression"] 
...
had_bmi_comorbid_dementia <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_dementia"] 
...
had_bmi_comorbid_psychosis_schiz_bipolar <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_psychosis_schiz_bipolar"] 
...
had_bmi_comorbid_diabetes_t1 <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_diabetes_t1"] 
...
had_bmi_comorbid_diabetes_t2 <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_diabetes_t2"] 
...
had_bmi_comorbid_asthma <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_asthma"] 
...
had_bmi_comorbid_COPD <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_COPD"] 
...
had_bmi_comorbid_stroke_and_TIA <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_stroke_and_TIA"] 
...
had_bmi_comorbid_chronic_cardiac <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_chronic_cardiac"] 
...
had_bmi_comorbid_hypertension <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_hypertension"] 
...
had_bmi_comorbid_all_cancer <- BMI_complete_categories_2019_DT[had_bmi=="TRUE", .(n_had_bmi= .N), by="comorbid_all_cancer"] 
...
write.csv (had_bmi_table, here::here ("output/data","proportion_had_bmi_check_2019.csv"))
write.csv (had_bmi_numbers_check, here::here ("output/data","had_bmi_numbers_check.csv"))
