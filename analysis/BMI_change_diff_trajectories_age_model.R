...
write.csv (models_trajectory_change_hypertension, here::here ("output/data","age_adjusted_bmi_trajectory_change_hypertension.csv"))
write.csv (models_trajectory_change_T2DM, here::here ("output/data","age_adjusted_bmi_trajectory_change_T2DM.csv"))
write.csv (models_trajectory_change_T1DM, here::here ("output/data","age_adjusted_bmi_trajectory_change_T1DM.csv"))
