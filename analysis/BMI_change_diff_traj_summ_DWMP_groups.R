...
write.csv (BMI_T1DM_traj_change_summary, here::here ("output/data","mean_bmi_traj_change_t1dm.csv"))

write.csv (BMI_T2DM_traj_change_summary, here::here ("output/data","mean_bmi_traj_change_t2dm.csv"))
