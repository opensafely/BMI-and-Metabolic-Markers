...
age <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  age_group_2, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

age

imp_age <- with(BMI_imp_long_mids,
               lm(trajectory_change ~ age_group_2 +  age_group_2 +  age_group_2))
...
imp_sex <- with(BMI_imp_long_mids,
                lm(trajectory_change ~ age_group_2 +  age_group_2 +  sex))
...
sex <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  sex, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_ethnic <- with(BMI_imp_long_mids,
                   lm(trajectory_change ~ age_group_2 +  age_group_2 +  eth_group_16))
...
ethnic <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  eth_group_16, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_imd <- with(BMI_imp_long_mids,
                lm(trajectory_change ~ age_group_2 +  age_group_2 +  imd))
...
imd <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  imd, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_region <- with(BMI_imp_long_mids,
                   lm(trajectory_change ~ age_group_2 +  age_group_2 +  region))
...
region <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  region, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_hypertension <- with(BMI_imp_long_mids,
                         lm(trajectory_change ~ age_group_2 +  age_group_2 +  hypertension))
...
hypertension <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  hypertension, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_diabetes_t1 <- with(BMI_imp_long_mids,
                        lm(trajectory_change ~ age_group_2 +  age_group_2 +  diabetes_t1))
...
diabetes_t1 <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  diabetes_t1, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_diabetes_t2 <- with(BMI_imp_long_mids,
                        lm(trajectory_change ~ age_group_2 +  age_group_2 +  diabetes_t2))
...
diabetes_t2 <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  diabetes_t2, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_chronic_cardiac <- with(BMI_imp_long_mids,
                            lm(trajectory_change ~ age_group_2 +  age_group_2 +  chronic_cardiac))
...
chronic_cardiac <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  chronic_cardiac, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_learning_disability <- with(BMI_imp_long_mids,
                                lm(trajectory_change ~ age_group_2 +  age_group_2 +  learning_disability))
...
learning_disability <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  learning_disability, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_psychosis_schiz_bipolar <- with(BMI_imp_long_mids,
                                    lm(trajectory_change ~ age_group_2 +  age_group_2 +  psychosis_schiz_bipolar))
...
psychosis_schiz_bipolar <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  psychosis_schiz_bipolar, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_depression <- with(BMI_imp_long_mids,
                       lm(trajectory_change ~ age_group_2 +  age_group_2 +  depression))
...
depression <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  depression, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


imp_COPD <- with(BMI_imp_long_mids,
                 lm(trajectory_change ~ age_group_2 +  age_group_2 +  COPD))
...
COPD <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  COPD, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_asthma <- with(BMI_imp_long_mids,
                   lm(trajectory_change ~ age_group_2 +  age_group_2 +  asthma))
...
asthma <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  asthma, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_dementia <- with(BMI_imp_long_mids,
                     lm(trajectory_change ~ age_group_2 +  age_group_2 +  dementia))
...
dementia <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  dementia, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)


##
imp_stroke_and_TIA <- with(BMI_imp_long_mids,
                           lm(trajectory_change ~ age_group_2 +  age_group_2 +  stroke_and_TIA))
...
stroke_and_TIA <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  stroke_and_TIA, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)

##
imp_smoking_status <- with(BMI_imp_long_mids,
                           lm(trajectory_change ~ age_group_2 +  age_group_2 +  smoking_status))
...
smoking_status <- lm(trajectory_change ~ age_group_2 +  age_group_2 +  smoking_status, data=BMI_trajectories) %>% 
  broom::tidy(conf.int = TRUE)
