...
## 4th April 2022
## This file calculates the proportions of the population who had a BMI measured in 2020 and differences (univariate) between groups
...
# all_2020 <- read_feather (here::here ("Documents/Academic GP/Open Safely/Dummy Data", "input_all_2020-03-01.feather"))
# BMI_complete_categories <- read_feather(here::here ("Documents/Academic GP/Open Safely/Dummy Data", "BMI_complete_median_2020.feather" ))
...
Hmisc::describe(all_2020$sbp)
## all missing sbp have been coded as 0 >> replace with NA
all_2020$sbp[all_2020$sbp<10] <- NA


Hmisc::describe(all_2020$sbp_date_measured)

all_2020 <- all_2020 %>%
  dplyr::mutate(had_sbp = as.numeric(sbp_date_measured))


all_2020$had_sbp[is.na(all_2020$had_sbp)] <- 0
...
sbp_2020 <- left_join(all_2020, BMI_complete_categories, by='patient_id')
...
sbp_2020 <- left_join(sbp_2020, precovid_obese, by='patient_id')
...
sbp_2020$imd[sbp_2020$imd == 0] <- NA
...
sbp_2020_DT <- data.table(sbp_2020)
...
## Whole population
N_had_sbp <- sbp_2020_DT[, .N, ]
had_sbp_table<- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N),] 
...
N_age_group <- sbp_2020_DT[, .N, by="age_group"]
had_sbp_age_group <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="age_group"] 
...
# 3. chisq test
age_group_chisq <- as_tibble(sbp_2020) %>%
...
#1.  count by sex
N_sex <- sbp_2020_DT[, .N, by="sex"]
had_sbp_sex <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="sex"] 
...
#1.  count by region
N_region <- sbp_2020_DT[, .N, by="region"]
had_sbp_region <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="region"] 
...
# 3. chisq test
region_chisq <- as_tibble(sbp_2020) %>%
...
#1.  count by imd
N_imd <- sbp_2020_DT[, .N, by="imd"]
had_sbp_imd <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="imd"] 
...
N_ethnic_no_miss <- sbp_2020_DT[, .N, by="ethnic_no_miss"]
had_sbp_ethnic_no_miss <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="ethnic_no_miss"] 
...
# 3. chisq test
ethnic_no_miss_chisq <- as_tibble(sbp_2020) %>%
...
N_eth_group_16 <- sbp_2020_DT[, .N, by="eth_group_16"]
had_sbp_eth_group_16 <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="eth_group_16"] 
...
# 3. chisq test
eth_group_16_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_learning_disability <- sbp_2020_DT[, .N, by="comorbid_learning_disability"]
had_sbp_comorbid_learning_disability <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_learning_disability"] 
...
# 3. chisq test
comorbid_learning_disability_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_depression <- sbp_2020_DT[, .N, by="comorbid_depression"]
had_sbp_comorbid_depression <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_depression"] 
...
# 3. chisq test
comorbid_depression_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_dementia <- sbp_2020_DT[, .N, by="comorbid_dementia"]
had_sbp_comorbid_dementia <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_dementia"] 
...
# 3. chisq test
comorbid_dementia_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_psychosis_schiz_bipolar <- sbp_2020_DT[, .N, by="comorbid_psychosis_schiz_bipolar"]
had_sbp_comorbid_psychosis_schiz_bipolar <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_psychosis_schiz_bipolar"] 
...
# 3. chisq test
comorbid_psychosis_schiz_bipolar_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_diabetes_t1 <- sbp_2020_DT[, .N, by="comorbid_diabetes_t1"]
had_sbp_comorbid_diabetes_t1 <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_diabetes_t1"] 
...
# 3. chisq test
comorbid_diabetes_t1_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_diabetes_t2 <- sbp_2020_DT[, .N, by="comorbid_diabetes_t2"]
had_sbp_comorbid_diabetes_t2 <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_diabetes_t2"] 
...
# 3. chisq test
comorbid_diabetes_t2_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_asthma <- sbp_2020_DT[, .N, by="comorbid_asthma"]
had_sbp_comorbid_asthma <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_asthma"] 
...
# 3. chisq test
comorbid_asthma_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_COPD <- sbp_2020_DT[, .N, by="comorbid_COPD"]
had_sbp_comorbid_COPD <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_COPD"] 
...
# 3. chisq test
comorbid_COPD_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_stroke_and_TIA <- sbp_2020_DT[, .N, by="comorbid_stroke_and_TIA"]
had_sbp_comorbid_stroke_and_TIA <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_stroke_and_TIA"] 
...
# 3. chisq test
comorbid_stroke_and_TIA_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_chronic_cardiac <- sbp_2020_DT[, .N, by="comorbid_chronic_cardiac"]
had_sbp_comorbid_chronic_cardiac <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_chronic_cardiac"] 
...
# 3. chisq test
comorbid_chronic_cardiac_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_hypertension <- sbp_2020_DT[, .N, by="comorbid_hypertension"]
had_sbp_comorbid_hypertension <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_hypertension"] 
...
# 3. chisq test
comorbid_hypertension_chisq <- as_tibble(sbp_2020) %>%
...
N_comorbid_all_cancer <- sbp_2020_DT[, .N, by="comorbid_all_cancer"]
had_sbp_comorbid_all_cancer <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="comorbid_all_cancer"] 
...
# 3. chisq test
comorbid_all_cancer_chisq <- as_tibble(sbp_2020) %>%
...
N_BMI_categories <- sbp_2020_DT[, .N, by="BMI_categories"]
had_sbp_BMI_categories <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="BMI_categories"] 
...
# 3. chisq test
BMI_categories_chisq <- as_tibble(sbp_2020) %>%
...
N_precovid_obese_flag <- sbp_2020_DT[, .N, by="precovid_obese_flag"]
had_sbp_precovid_obese_flag <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="precovid_obese_flag"] 
...
# 3. chisq test
precovid_obese_flag_chisq <- as_tibble(sbp_2020) %>%
...
write.csv (had_sbp_table, here::here ("output/data","proportion_had_sbp_2020.csv"))