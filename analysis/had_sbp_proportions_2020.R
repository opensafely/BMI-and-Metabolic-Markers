...
all_2020 <- BMI_complete_categories
...
########### had_bmi
#1.  count by had_bmi
N_had_bmi <- sbp_2020_DT[, .N, by="had_bmi"]
had_sbp_had_bmi <- sbp_2020_DT[had_sbp=="TRUE", .(n_had_sbp= .N), by="had_bmi"] 
...
# 3. chisq test
had_bmi_chisq <- as_tibble(sbp_2020) %>%
